    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow max-w-7xl mx-auto px-6 md:px-45 py-8">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-semibold italic py-6">Recent Blogs</h2>
          <div className="bg-blue-100 py-9 px-7 rounded-xl">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[...Array(6)].map((_, index) => (
              <div key={index} className="bg-blue-100 p-6 rounded-xl min-h-[200px]" />
            ))}
          </div>
        </section>
      </main>
